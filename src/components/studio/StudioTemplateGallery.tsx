...
const TEMPLATES: StudioTemplate[] = [
  ...
  },
  {
    ...
    elements: [
      ...
      { id: tid(), type: "text", x: 80, y: 130, width: 500, height: 35, content: "SATURDAY, APRIL 26, 2026", style: { fontSize: "16px", fontWeight: "600", color: "#6B8DD6", letterSpacing: "4px" }, visible: true, locked: false, fontFamily: "Space Grotesk", filters: { ...DEFAULT_FILTERS } },
  ...
  /* ─── EDUCATION / SCHOOL ─── */
  {
    ...
    elements: [
      ...
      { id: tid(), type: "text", x: 80, y: 130, width: 500, height: 30, content: "MONDAY 14 APRIL 2026", style: { fontSize: "16px", fontWeight: "600", color: "#3B82F6", letterSpacing: "4px" }, visible: true, locked: false, fontFamily: "Space Grotesk", filters: { ...DEFAULT_FILTERS } },
