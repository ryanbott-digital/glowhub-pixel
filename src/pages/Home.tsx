      ...
      <footer className="border-t border-[#1E293B] py-10 px-6">
        <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6 text-sm text-[#64748B]">
            ...
            <button onClick={() => { localStorage.removeItem("glow-cookie-consent"); window.dispatchEvent(new Event("cookie-reset")); }} className="hover:text-[#E2E8F0] transition-colors">Cookie Preferences</button>
          </div>
